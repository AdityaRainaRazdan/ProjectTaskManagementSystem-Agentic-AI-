...
namespace projectTaskManage.Module
{
    ...
    public sealed class projectTaskManageModule : ModuleBase
    {
        public projectTaskManageModule()
        {
            //
            // projectTaskManageModule
            //
            AdditionalExportedTypes.Add(typeof(projectTaskManage.Module.BusinessObjects.ApplicationUser));
