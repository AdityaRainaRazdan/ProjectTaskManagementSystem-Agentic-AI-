...
namespace projectTaskManage.Module.DatabaseUpdate
{
    ...
    public class Updater : ModuleUpdater
    {
        ...
        public override void UpdateDatabaseAfterUpdateSchema()
        {
            ...
            var admin = ObjectSpace.FirstOrDefault<PermissionPolicyUser>(u => u.UserName == "Admin");
            if (admin == null)
            {
                admin = ObjectSpace.CreateObject<PermissionPolicyUser>();
                admin.UserName = "Admin";
                admin.SetPassword("abc"); // empty password
