...
namespace projectTaskManage.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<projectTaskManageWindowsFormsApplication>();
            builder.Modules
                .AddAuditTrailEFCore()
                .AddCharts()
                .AddCloning()
                ...
                .AddViewVariants()
                .Add<projectTaskManage.Module.projectTaskManageModule>()
                .Add<projectTaskManageWinModule>();
            ...
            builder.Security
                .UseIntegratedMode(options =>
                {
                    ...
                    options.UserType = typeof(projectTaskManage.Module.BusinessObjects.ApplicationUser);
                    options.UserLoginInfoType = typeof(projectTaskManage.Module.BusinessObjects.ApplicationUserLoginInfo);
